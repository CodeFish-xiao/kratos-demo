...
const (
	FileUploadService_UploadFile_FullMethodName = "/demo.file_upload.FileUploadService/UploadFile"
)
...
func (c *fileUploadServiceClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (*UploadFileReply, error) {
...
func (UnimplementedFileUploadServiceServer) UploadFile(context.Context, *UploadFileRequest) (*UploadFileReply, error) {
...
func _FileUploadService_UploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileUploadServiceServer).UploadFile(ctx, req.(*UploadFileRequest))
	}
...
var FileUploadService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "demo.file_upload.FileUploadService",
	...
	Metadata: "file_upload/file.proto",
}
